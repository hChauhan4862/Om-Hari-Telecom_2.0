...
if __name__ == "__main__":
    # test = AadhaarPDF("AADHAAR/2015/chitresh kumari.pdf",password="202132", bruteForce=True)
    # test = AadhaarPDF("AADHAAR/2016/DHANJAY BHARATI.pdf",password="202132", bruteForce=True)
    # test = AadhaarPDF("AADHAAR/2017/nisha sharma.pdf",password="202132", bruteForce=True)
    # test = AadhaarPDF("AADHAAR/2017/anju kumari (3).pdf",password="202132", bruteForce=True)
    # test = AadhaarPDF("AADHAAR/2020/LALIT KUMAR 2017.pdf",password="202132", bruteForce=True)
    # test = AadhaarPDF("AADHAAR/2021/HIMANSHU VARSHNEY 2004.pdf",password="202132", bruteForce=True)
    # test = AadhaarPDF("AADHAAR/2022/CHANCHAL 2022.pdf",password="202132", bruteForce=True)
    # test = AadhaarPDF("AADHAAR/2023/KAPIL KUMAR 1993.pdf",password="202132", bruteForce=True)

    # test = AadhaarPDF("AADHAAR/2018/khushal chauhan 2013.pdf",password="202132", bruteForce=True)
    # test = AadhaarPDF("AADHAAR/2018/VINOD KUMAR 1956.pdf",password="202132", bruteForce=True)

    with open("KM. DIPSI CHAUHAN 2000.pdf", "rb") as f:
        test = AadhaarPDF(f,password="202132", bruteForce=True)
    data = test.get_json()
    # print(data)