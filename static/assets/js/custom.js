...
(function ($) {
  ...
  if (darkMode) {
    ...
    if (!localStorage.getItem('dayonecolorheader') && !localStorage.getItem('dayonegradientheader') && !localStorage.getItem('dayonelightheader')) {
      $('#background3').prop('checked', true);
    }

    if (!localStorage.getItem('dayonecolormenu 	') && !localStorage.getItem('dayonegradientmenu') && !localStorage.getItem('dayonelightmenu')) {
      $('#background6').prop('checked', true);
    }
  }
